...
public class MailService {
    ...
    public void sendActivationEmail(String mail, String subject, String message, String title ,String buttonTitle, String url)  {
        try {
            MimeMessage mimeMessage = javaMailSender.createMimeMessage();
            MimeMessageHelper mailHelper = new MimeMessageHelper(mimeMessage, true, "UTF-8");

            String templateMsg = " <!DOCTYPE html>\n" + //
                    "<html>\n" + //
                    "<head>\n" + //
                    "\n" + //
                    "  <meta charset=\"utf-8\">\n" + //
...
//                    "              <p style=\"margin: 0;\">Cheers,<br> Paste</p>\n" + //
            ...
            mailHelper.setText(templateMsg, true);
